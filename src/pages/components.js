      ...
      <div>
        ...
        <div className="container">
          ...
          <button className="btn btn-primary rounded">
            <i className="ti-thumb-up pr-1"></i> With Icon
          </button>
          ...
          <h3 className="components-section-title font-weight-normal">
            Dropdowns
          </h3>
          <hr />
              ...
              >
                <ul className="navbar-nav ml-auto">
                  ...
                  <li className="nav-item">
                    <a
                      href="#book-table"
                      className="ml-4 mt-1 btn btn-light btn-sm"
                    >
                      navbar button
                    </a>
                  </li>
              ...
              >
                <ul className="navbar-nav ml-auto">
                  ...
                  <li className="nav-item">
                    <a
                      href="#book-table"
                      className="ml-4 mt-1 btn btn-dark btn-sm"
                    >
                      navbar button
                    </a>
                  </li>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-md-6">
              ...
              <h6 className="section-secondary-title mt-4 mb-2">
                Badge Pills :
              </h6>
              ...
              <tr>
                ...
                <td>
                  <p>
                    ...
                    Fugiat explicabo ab sed voluptas odit hic obcaecati qui
                    omnis.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <p className="text-muted">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    In, nulla, reprehenderit! Beatae, dolor harum fugiat.
                  </p>
                </td>
              </tr>
              <tr>
